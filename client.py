...
def download():    
    ...
    download_status.configure(text="Downloading...."+ song_to_download)
    time.sleep(5)
    HOSTNAME = "127.0.0.1"
    USERNAME = "lftpd"
    PASSWORD = "lftpd"
    ...
    file.close()
    ftp_server.quit()
    download_status.configure(text="Download Complete")
    window.after(4000, clear_label)
...
def musicWindow(): 
    ...
    download_status = Label(window, text= "",fg= "blue",bg='SkyBlue', font = ("Calibri",10))
    download_status.place(x=4, y=360)
